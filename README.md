...
3. ** Open your terminal and navigate a file where you want to store the project. **
...
5. ** Now you can navigate to the prject folder of the cloned repository. **
  <img width="1177" height="600" alt="image" src="https://github.com/user-attachments/assets/82ae6ce5-84b9-45e3-9e54-c59502e0262f" />
6. **Look for the README.md as it almost always contains the documentation on how to run the project. Because some projects has installation guide that needs to be done first before you run the project.
   - For this project, we can run it by opening the index file as it only contains html,css, and javascript.
